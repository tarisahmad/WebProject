...
Route::get('/syarat','user\WelcomeController@syarat')->name('syarat');
...
Route::group(['middleware' => ['auth','checkRole:admin']],function(){    
    ...
    Route::get('/admin/transaksi/konfirm','admin\TransaksiController@konfirm')->name('admin.transaksi.konfirm');
