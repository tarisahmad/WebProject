...
<html lang="en">
  <head>
    <title>MRS Rent &mdash; Toko Kamera Online </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/" class="js-logo-clone">MRS Rent</a>
              </div>
            </div>
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="{{ Request::path() === 'produk' ? '' : '' }}"><a href="{{ route('user.produk') }}">Kategori</a></li>
            <li class="{{ Request::path() === 'syarat' ? '' : '' }}"><a href="{{ route('syarat') }}">Syarat dan ketentuan</a></li>
          </ul>
        </div>
      </nav>
    </header>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Villa Grand Tomang</li>
                <li class="phone"><a href="tel://23923929210">085156026754</a></li>
                <li class="email">mrsrent@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
