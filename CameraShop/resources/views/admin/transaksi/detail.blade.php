                  ...
                  <div class="card-body">
                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td>Konfirmasi Pengambilan Barang</td>
                            <td>:</td>
                            <td  class="p-2">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" placeholder="Konfirmasi" aria-label="Recipient's username" aria-describedby="basic-addon2" name="konfirmasi" required>
