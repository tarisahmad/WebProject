    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('adminassets') }}/assets/images/mini.svg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('adminassets') }}/assets/images/mini.jpg" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2">Dashboard</span>
            ...
            <li class="nav-item ">
              ...
              <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.perludicek') }}">Perlu Di Cek</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.konfirm') }}">Konfirmasi Ambil Barang</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{ route('admin.transaksi.dikirim') }}">Pengambilan Barang</a></li>
        ...
        <div class="main-panel">
         @yield('content')
          ...
          <footer class="footer">
            ...
            Copyright &copy;<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>document.write(new Date().getFullYear());</script> All rights reserved by MRS Rent</a>
            </div>
          </footer>
          <!-- partial -->
        </div>
