...
class TransaksiController extends Controller
{
    ...
    public function konfirm()
    {
        ...
        return view('admin.transaksi.konfirm',$data);
    }
    ...
    public function konfirmasi($id)
    {
        ...
        return redirect()->route('admin.transaksi.konfirm')->with('status','Berhasil Mengonfirmasi Pembayaran Pesanan');
    }
    ...
    public function inputresi($id,Request $request)
    {
        ...
        $order = Order::findOrFail($id);
        $order->konfirmasi = $request->konfirmasi;
        $order->status_order_id = 4;
        $order->save();
        return redirect()->route('admin.transaksi.konfirm')->with('status','Konfirmasi Pengambilan oleh Customer');
    }
}
