...
<head>
	...
	<title><?php echo $hal; ?> · Aplikasi Peminjaman Ruang</title>
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/bootstrap.min.css'); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/login.css'); ?>">
	<link rel="icon" href="<?php echo base_url('assets/img/jateng.png'); ?>">
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row baris-utama">
			...
			<div class="col-sm-8 kotak-login clearfix">
				...
				<div class="gambar-login">
					<p>Selamat <br><b3>datang<font color="ffc000">.</font></b3></p>
				</div>
				<!-- Kolom Gambar Selamat Datang -->
				
				<!-- Form Login -->
				<div class="login-form">
					<img src="<?php echo base_url('assets/img/jateng.png'); ?>">
		...
		<div class="row baris-footer">
			<!-- Kolom Copyright -->
			<div class="col-sm-12">&copy; 2021-<?php echo date('Y'); ?> Pinjam ruang</div>
			<!-- Kolom Copyright -->
		</div>
