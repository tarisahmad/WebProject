<table>
	<tr>
		...
		<th>Kapasitas</th>
		<?php if($this->session->userdata('level') == "1"): ?><th>Aksi</th><?php endif; ?>
	</tr>
	...
	<tr>
		...
		<td align="center"><?php echo $baris['kapasitas']; ?></td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul>
					...
					<li>
						<div><i class="lnr lnr-text-format"></i></div><input type="text" name="kapasitas" placeholder="Kapasitas" required />
					</li>
					<br /><hr />
					<li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<ul>
					...
					<li>
						<div><i class="lnr lnr-text-format"></i></div><input type="text" name="kapasitas" placeholder="Kapasitas" value="<?php echo $baris['kapasitas']; ?>" required />
					</li>
					<br /><hr />
					<li>
